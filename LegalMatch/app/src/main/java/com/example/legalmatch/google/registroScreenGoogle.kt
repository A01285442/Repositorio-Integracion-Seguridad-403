...
val nowGoogle = Clock.System.now().toLocalDateTime(TimeZone.currentSystemDefault())
@RequiresApi(Build.VERSION_CODES.O)
data class UserRegistrationDataGoogle @RequiresApi(Build.VERSION_CODES.O) constructor(
    var name: String = "",
    var lastname: String = "",
    var dateOfBirth: LocalDateTime = nowGoogle,
    var sex: String = "",
    var email: String = "",
    var password: String = "",
    var googleId: String = ""
...
@RequiresApi(Build.VERSION_CODES.O)
@Composable
fun RegisterScreenGoogle(navController: NavController, viewModel: LoginViewModel,googleId: String, googleEmail: String) {
    var currentStep by remember { mutableIntStateOf(1) }
    var registrationData by remember { mutableStateOf(UserRegistrationDataGoogle(email = googleEmail)) }
...
@Composable
fun SexScreenGoogle(value: String, onValueChange: (String) -> Unit, onContinue: () -> Unit) {
...
@Composable
fun GenderRadioButtonGoogle(selectedGender: String, onGenderSelected: (String) -> Unit) {
